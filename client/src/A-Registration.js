...
const Registration = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3001/Assreg', {
        method: 'POST',
        body: data,
      });
  ...
  return (
    <div className="container mt-5">
       <h1 className="mb-4" style={{ color: 'white', textAlign: 'center', textShadow: '2px 2px black' }}>Registration for Associate Programmer</h1>
